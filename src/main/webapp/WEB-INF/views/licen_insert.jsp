...
<body>
	<div id="wrap">
		...
		<div id="contents">
			<div id="content">
				<form action="licen_insert" method="post">
					<input type="hidden" value="${license.no }" name="no">
					<table width="640" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td height="25"><img src="resources/image/icon.gif"
								width="9" height="9" align="absmiddle"> <strong>자격증
									. 보유기술 정보 수정</strong></td>
						</tr>
						<tr>
																	...
																	<table width="439" border="0" cellpadding="0"
																		...
																		<tr align="left">
																			...
																			<td width="173"><strong> <input
																					name="license_name1" type="text" size="20"
																					value="${license.license_name1}">
																			</strong></td>
																			<td width="60"><strong>취득일</strong></td>
																			<td width="133"><strong> </strong><strong>
																					<input name="license_date1" type="text" size="20"
																					value="${license.license_date1}">
																			</strong></td>
																		</tr>
																	</table></td>
															</tr>
															<tr>
																<td height="26" align="center" bgcolor="#E4EBF1"><table
																		...
																		<tr align="left">
																			<td width="73"><strong>자격증 </strong></td>
																			<td width="173"><strong> <input
																					name="license_name2" type="text" size="20"
																					value="${license.license_name2}">
																			</strong></td>
																			<td width="60"><strong>취득일</strong></td>
																			<td width="133"><strong> </strong><strong>
																					<input name="license_date2" type="text" size="20"
																					value="${license.license_date2}">
																			</strong></td>
																		</tr>
																	</table></td>
															</tr>
															<tr>
																<td height="26" align="center" bgcolor="#E4EBF1"><table
																		...
																		<tr align="left">
																			<td width="73"><strong>자격증 </strong></td>
																			<td width="173"><strong> <input
																					name="license_name3" type="text" size="20"
																					value="${license.license_name3}">
																			</strong></td>
																			<td width="60"><strong>취득일</strong></td>
																			<td width="133"><strong> </strong><strong>
																					<input name="license_date3" type="text" size="20"
																					value="${license.license_date3}">
																			</strong></td>
																		</tr>
																	</table></td>
															</tr>
															<tr>
																<td height="26" align="center" bgcolor="#E4EBF1"><table
																		...
																		<tr align="left">
																			<td width="73"><strong>자격증 </strong></td>
																			<td width="173"><strong> <input
																					name="license_name4" type="text" size="20"
																					value="${license.license_name4}">
																			</strong></td>
																			<td width="60"><strong>취득일</strong></td>
																			<td width="133"><strong> </strong><strong>
																					<input name="license_date4" type="text" size="20"
																					value="${license.license_date4}">
																			</strong></td>
																		</tr>
																	</table></td>
															</tr>
																...
																<td height="26" align="center" bgcolor="#E4EBF1"><table
																		...
																		<tr align="left">
																			...
																			<td width="206"><strong> </strong><strong>
																					...
																					name="license_proficiency1" value="중">
																					중 <input type="radio" name="license_proficiency1"
																					value="고"> 고
																			</strong></td>
																		</tr>
																	</table></td>
